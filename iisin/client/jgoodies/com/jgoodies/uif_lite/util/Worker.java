package com.jgoodies.uif_lite.util;
...
public abstract class Worker {
     ...
     * 
     * @return the value to be returned by teh <code>get</code> method
     * @see #get() 
     */
    ...
    /** 
     * Get the value produced by the worker thread, or <code>null</code> if it 
     * hasn't been constructed yet.
     * 
     * @return the value produced by this worker, or <code>null</code>
     ...
     * Start the worker thread.
     * 
     * @param priority    the priority used for the background thread
     */
